...
class GreedyTargetRateAgent(BaseAgent):
    ...
    def save(self, path: str) -> None:
        raise NotImplementedError("GreedyTargetRateAgent does not support saving.")

    @classmethod
    def load(cls, path: str):
        raise NotImplementedError("GreedyTargetRateAgent does not support loading.")
